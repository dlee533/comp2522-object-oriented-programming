...
public class RPNCalculatorTest {
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase1() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(2);
        calculator.push(7);
        calculator.perform(new PrimeSumOperation());
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase2() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(7);
        calculator.push(2);
        calculator.perform(new PrimeSumOperation());
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase3() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(1);
        calculator.push(0);
        calculator.perform(new PrimeSumOperation());
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase4() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(2);
        calculator.push(2);
        calculator.perform(new PrimeSumOperation());
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase5() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(-5);
        calculator.push(5);
        calculator.perform(new PrimeSumOperation());
    ...
    @Test
    public void performAcceptsPrimeSumOperatorCase6() throws InvalidOperationTypeException, StackUnderflowException, StackOverflowException {
        calculator = new RPNCalculator(2);
        calculator.push(-10);
        calculator.push(-15);
        calculator.perform(new PrimeSumOperation());
